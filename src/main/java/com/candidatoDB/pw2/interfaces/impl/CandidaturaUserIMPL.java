...
public class CandidaturaUserIMPL implements CandidaturaUserDAO {
    ...
    public void Save(CandidaturaUser candidaturaUser) {
        ...
        try {
             ...
             statement.setTimestamp(3, new java.sql.Timestamp(candidaturaUser.getData_candidatura().getTime()));
        ...
        try {
            ...
            if(!resultSet.isBeforeFirst()){
                ...
                while (resultSet.next()) {
    				...
    				candidatura.setData_candidatura(new Date(resultSet.getTimestamp(4).getTime()));
