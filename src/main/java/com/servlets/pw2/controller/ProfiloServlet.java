...
public class ProfiloServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if ((!utenteInSessione.getEmail().equals(utenteModificato.getEmail()))
				...
				&& (!dbOperationsr.ChechUserAll1(utenteModificato))) {
			...
			req.getRequestDispatcher("/home/profilo.jsp").forward(req, resp);
				...
				&& (!utenteInSessione.getTelefono().equals(utenteModificato.getTelefono()))
				&& (!dbOperationsr.ChechUserMailAndTel(utenteModificato))) {
			System.out.println("dentro");
			UtenteIMPL utenteIMPL = new UtenteIMPL();
			...
			req.getRequestDispatcher("/home/profilo.jsp").forward(req, resp);
				...
				&& (!utenteInSessione.getCodice_fiscale().equals(utenteModificato.getCodice_fiscale()))
				&& (!dbOperationsr.ChechUserMailAndCodF(utenteModificato))) {
			System.out.println("dentro");
			UtenteIMPL utenteIMPL = new UtenteIMPL();
			...
			req.getRequestDispatcher("/home/profilo.jsp").forward(req, resp);
				...
				&& (!utenteInSessione.getCodice_fiscale().equals(utenteModificato.getCodice_fiscale()))
				&& (!dbOperationsr.ChechUserTelAndCodF(utenteModificato))) {
			System.out.println("dentro");
			UtenteIMPL utenteIMPL = new UtenteIMPL();
		 ...
		 * session.removeAttribute("utente"); session.setAttribute("utente",
		 * utenteModificato); }else if(isModified){
		 * ErrorManager.setSuccessMessage("Modifiche effettuate correttamente!",req); }
		 * else { ErrorManager.setOtherMessage("Non hai modificato nulla!",req); }
		 */
		// req.getRequestDispatcher("/home/profilo.jsp").forward(req, resp);
	}
