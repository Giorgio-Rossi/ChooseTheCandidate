...
<body>
    ...
    <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse " style="background-color:#0072BC">
        <div class="position-sticky">
            <div class="list-group list-group-flush mx-3 mt-5" style="gap: 3rem">
                ...
                <a href="${pageContext.request.contextPath}/visualizzaCandidature.jsp" class="list-group-item list-group-item-action py-2 ripple">
    <i class="bi bi-eye" style="margin-right: 5px; font-size: 20px"></i><span> Candidature effettuate</span>
</a>
    ...
    <nav id="main-navbar" class="navbar navbar-expand-lg navbar-light bg-white fixed-top" style="background-color:white;">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="${pageContext.request.contextPath}/home/homeuser.jsp">
                <img
            ...
            <span>
                <a href="${pageContext.request.contextPath}/home/homeuser.jsp"><h1><span style="float:right;font-family:Comic Sans MS">JOBHUNTER &thinsp;</span></h1></a>
            </span>
        </div>
    </nav>
