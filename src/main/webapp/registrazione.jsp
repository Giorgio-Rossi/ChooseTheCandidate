		...
		<div class="formRegistra2">
			<form method="post" action="${pageContext.request.contextPath}/registrazione" >
				<div class="formleft2">
					...
					<input class="input2" type="password"  name="password" id="password" placeholder="Password"  required><br>
				...
				<div class="formright2">
					...
					<input class="input2" type="password" name="check_password" id="check_password" placeholder="Password"  required><br>
