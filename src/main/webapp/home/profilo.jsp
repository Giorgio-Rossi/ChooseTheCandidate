									...
									<div class="e-profile">
										<div class="row justify-content-center">
											<div class="col-12 col-sm-auto mb-3">
												...
												%>
												<img
													src=<%=request.getContextPath() + "/img/fotoprofili" + utente.getFoto_profilo()%>
											...
											<div class="d-flex justify-content-center">
												<label for="fileUpload"
													...
													class="bi bi-upload"></i> Cambia la foto profilo <input
													id="fileUpload" type="file" accept="image/*"
													name="foto_profilo" form="modifica_profilo"
													style="display: none"> </label>
											</div>
											<div class="text-center text-sm-right">
												<div class="text-muted">
													<small>Registrato il 09 Dec 2017</small>
												</div>
											</div>
										</div>
										<div class="tab-content pt-3">
											<div class="tab-pane active">
												<form class="form" method="post"
													action="${pageContext.request.contextPath}/profiloUtente"
													id="modifica_profilo" enctype='multipart/form-data'>
													<div class="row">
														<div class="col">
															<div class="row">
																<div class="col">
																	<div class="form-group">
																		<label>Nome</label> <input class="form-control"
																			type="text" name="nome"
																			placeholder=<%=utente.getNome()%>
																			value=<%=utente.getNome()%> required>
																	</div>
																</div>
																<div class="col">
																	<div class="form-group">
																		<label>Cognome</label> <input class="form-control"
																			type="text" name="cognome"
																			placeholder=<%=utente.getCognome()%>
																...
																<div class="row">
																	<div class="col">
																		<div class="form-group">
																			<label>Genere</label> <select class="form-select"
																				aria-label="Default select example" name="genere">
																				<%
																				...
																				<option value="non specificare">Preferisco
																					non specificarlo</option>
																			</select>
																		</div>
																	</div>
																	<div class="col">
																...
																<div class="col">
																	<div class="form-group">
																		<label>Telefono</label> <input class="form-control"
																			type="tel" placeholder=<%=utente.getTelefono()%>
																			value=<%=utente.getTelefono()%> name="telefono">
																	</div>
																</div>
															</div>
															<div class="row">
																<div class="col">
																	<div class="form-group">
																		<label>Codice Fiscale</label> <input
																			class="form-control" type="text"
																			placeholder=<%=utente.getCodice_fiscale()%>
																...
																<div class="col">
																	<div class="form-group">
																		...
																		%>
																		<label>Città di nascita</label> <select
																			class="form-select"
																			...
																			<option
																				...
																				selected><%=utente.getId_citta().getNome()%></option>
																			<%
																			} else {
																			%>
																...
																<div class="col">
																	<div class="form-group">
																		<label>Email</label> <input class="form-control"
																			...
																			placeholder=<%=utente.getEmail()%>
																			value=<%=utente.getEmail()%> name="email" required>
																	</div>
																</div>
															</div>
															<div class="row">
																<div class="col">
																	<div class="form-group">
																		<label>Vecchia Password</label> <input
																			class="form-control" type="password"
																			placeholder="••••••" name="oldpsw">
																	</div>
																</div>
															</div>
															<div class="row">
