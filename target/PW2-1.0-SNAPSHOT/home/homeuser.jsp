...
<header>
    <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse " style="background-color:#0072BC">
        <div class="position-sticky">
            <div class="list-group list-group-flush mx-3 mt-5" style="gap: 3rem">
                ...
                <a href="${pageContext.request.contextPath}/findCandidature" class="list-group-item list-group-item-action py-2 ripple"><i class="bi bi-search" style="margin-right: 5px;font-size: 20px"></i><span>Candidature effettuate</span></a>
    ...
    <nav id="main-navbar" class="navbar navbar-expand-lg navbar-light bg-white fixed-top" style="background-color:white;">
        <div class="container-fluid">
            ...
            <h1 style="text-align:center;margin-top:10px">Ciao <%=utenteLoggato.getNome()%></h1>
            <span>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 d-flex align-items-stretch" style="padding-top: 50px">
                    <div class="card shadow-lg p-3 mb-5 bg-body rounded" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title" style="text-align: center"><a class="btn btn-info" href="${pageContext.request.contextPath}/candidaturaRecente">Candidatura più recente</a></h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 d-flex align-items-stretch" style="padding-top: 50px">
                    <div class="card shadow-lg p-3 mb-5 bg-body rounded" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title" style="text-align: center"><a class="btn btn-info" href="${pageContext.request.contextPath}/posizioniPiuRecenti">Annunci Recenti</a></h5>
                        </div>
                    </div>
                </div>
            </div>
